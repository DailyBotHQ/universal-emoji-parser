  ...
  describe('Using default options', () => {
    it('should parse emojis from unicode', () => {
      ...
      expect(result).to.be.equal(
        '<img class="emoji" alt="😀" src="https://twemoji.maxcdn.com/v/14.0.2/72x72/1f600.png"/>'
      )
      ...
      expect(result).to.be.equal(
        '<img class="emoji" alt="😄" src="https://twemoji.maxcdn.com/v/14.0.2/72x72/1f604.png"/>'
      )
    ...
    it('should parse emojis from shortcode', () => {
      ...
      let result: string = uEmojiParser.parse(text)
      expect(result).to.be.equal(
        '<img class="emoji" alt="🙂" src="https://twemoji.maxcdn.com/v/14.0.2/72x72/1f642.png"/>'
      )
